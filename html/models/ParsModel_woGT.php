...
$this->add_trace('3. ID : '.$this->sp_id.'   URL : '.$this->sp_url, 'value', __FUNCTION__);
$this->add_trace('3. cb_type_source_page : '.$this->cb_type_source_page.' sp_dp_id : '.$this->sp_dp_id, 'value', __FUNCTION__);
...
$this->add_trace('choose_pattern pr_id =  '.$pars_cond['pr_id'],'value', __FUNCTION__); 
        ...
        $expression = sprintf('count(%s) > 0', $pars_cond['pr_selector']);
         $this->add_trace('choose_pattern expression = '.$expression,'value', __FUNCTION__); 
